---
title: "`surveydown`<br><span style='font-size: 0.7em;'>An open-source platform for programmable,<br>markdown-based surveys</span>"
author: "<br>**Pingfan Hu**<br>George Washington University<br><br>USRSE'25"
format:
  revealjs: 
    smaller: false
    ...
    auto-stretch: false
    footer: "<a href='http://pingfanhu.com'>Pingfan Hu</a> - <a href='https://us-rse.org/usrse25/'>USRSE'25</a>"
    preview-links: auto
    ...
    title-slide-attributes:
      data-background-image: figs/logo-surveydown.png
      data-background-size: 18%
      data-background-opacity: "1"
      data-background-position: right 20% center
      class: custom-title-slide
      style: text-align:left; max-width:70%;
execute: 
  warning: false
  echo: false
---
...
![](figs/prof-x.gif){fig-align="center" width="90%" style="border: 2px solid #5654A2;"}

## {.light-centered .center}

![](figs/demo.gif){fig-align="center" width="85%" style="border: 2px solid #5654A2;"}
...
### Why not make surveys `code` based? 
...
![](figs/spiderman-oh-no.gif){width=80%}
...
![](figs/superman-think.gif){fig-align="center" width=50%}
...
::: {.column}
![](figs/superman-oh-yeah.gif){fig-align="center" width=60%}
:::
...
## Locally get the data {.light-centered .center}
...
::: {.column style="width: 48%; margin-left: -10px"}
![](figs/question-text.png){width=100%}
:::

## Question Type: `mc` {.light-centered .center}

<br>

::: {.column style="width: 52%; font-size: 0.7em;"}
...
::: {.column style="width: 44%; margin-left: -10px"}
![](figs/question-mc.png){width=100%}
:::
...
## Question Type: `slider_numeric` {.light-centered .center}
...
::: {.column style="width: 48%; margin-left: -10px"}
![](figs/question-slider-numeric.png){width=100%}
:::
...
![](figs/conditional-showing.gif){width=50% style="border: 2px solid #5654A2;"}
...
## Conditional skipping - `sd_skip_if()`<br><br> Conditional stopping - `sd_stop_if()` {.light-centered .center}
...
![](figs/llm.gif){fig-align="center" width=80% style="border: 2px solid #5654A2;"}
...
![](figs/sdstudio-build.gif){fig-align="center" width=100% style="border: 2px solid #5654A2;"}

##

![](figs/sdstudio-preview.gif){fig-align="center" width=100% style="border: 2px solid #5654A2;"}

##

![](figs/sdstudio-data.gif){fig-align="center" width=100% style="border: 2px solid #5654A2;"}

## With great power comes great responsibility. {.dark-centered .center style="font-size: 1.2em;"}

## Meet the team! {.light-centered .center}

<br>

::: {.column width="33%"}

[![](figs/member-john-helveston.png){fig-align="center" width="80%" .round-image}](https://www.jhelvy.com)
...
<a href="https://pingfanhu.com" target="_blank">![](figs/member-pingfan-hu.jpg){fig-align="center" width="80%" .round-image}</a>

Pingfan Hu
:::

::: {.column width="33%"}
[![](figs/member-bogdan-bunea.jpg){fig-align="center" width="80%" .round-image}](https://www.linkedin.com/in/bogdanbt/)
...
::: {.column width="40%"}
![](figs/qr-surveydown-repo.svg){fig-align="center" width=70% style="border: 2px solid #5654A2;"}
:::
...
### Thanks! {style="font-size: 1.5em;"}

![](figs/deadpool-heart.gif){fig-align="center" width=70% style="border: 2px solid #5654A2;"}

This work was sponsored by the Alfred P. Sloan Foundation.
...
![](figs/qr-surveydown-doc.svg){fig-align="center" width=70% style="border: 2px solid #5654A2;"}

::: {style="text-align: right;"}
[`jhelvy.com`](https://www.jhelvy.com)

<a href="https://pingfanhu.com" target="_blank">`pingfanhu.com`</a>
:::
:::
